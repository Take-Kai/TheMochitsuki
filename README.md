...
PC：MacBookPro 1.4GHzクアッドコアIntel Core i5, メモリ8GB
...
### Arduinoプログラム
Arduinoでは、杵と臼にそれぞれ取り付けられたボタンに応じてUnity側に対応する文字を送信しています。

杵のボタンなら「K」、臼のボタンなら「U」を送信しています。

どちらの文字が送信されたかによってUnity側で処理を分けています。
...
# アート&テクノロジー東北2023
<img width="444" alt="poster" src="https://github.com/Take-Kai/TheMochitsuki/assets/169955027/0d1ffaae-c058-49f2-a7ff-49d0d166d04f">

2023年7月15日に岩手大学で開催された「アート&テクノロジー東北2023大会」において、THE 餅つきは優秀賞をいただきました。

アート&テクノロジー東北2023[http://www-cg.cis.iwate-u.ac.jp/AT2023/]
